...
import librec.personality.PKNN1;
import librec.personality.PKNN2;
import librec.personality.PersAsReg1;
import librec.personality.PersAsReg2;
import librec.personality.PersMF;
import librec.personality.PersReg1;
import librec.personality.PersReg2;
...
public class LibRec {
	...
	protected Recommender getRecommender(SparseMatrix[] data, int fold) throws Exception {
		...
		case "persreg1":
			return new PersReg1(trainMatrix, testMatrix, fold);
		case "persreg2":
			return new PersReg2(trainMatrix, testMatrix, fold);
		case "persasreg1":
